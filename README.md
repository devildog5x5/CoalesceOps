...
**Hostinger zip:** [CoalesceOps-1.0.0.zip](https://github.com/devildog5x5/CoalesceOps/releases/download/v1.0.0/CoalesceOps-1.0.0.zip) — unzip into `public_html`. Rebuild with `powershell -File .\build_site_zip.ps1` (filename includes the version from `VERSION`). Footer on every page: Coalesce Ops v1.0.0.
